...
class AjaxCore
{
    var $currentfile;
    var $placeholder;
    var $placeholder_enabled = false; // gets enabled if used
    var $method = "get";
    var $output_headers = false;
    var $cache = false;
    var $updating;
    var $request;
    var $version = "1.4.0";
    ...
    var $trails = array();
    var $watcher = true;
    var $encode_vars=false;
    var $encode_values=true;
    ...
    * @access private
    */
    function onLoad ($bindto, $params = array(), $request = "bind", $timerms = 300)
    {
    ...
    */
    function triggerOnMismatchType($element,$elementname,$method,$type)
    {
        switch($type)
        {
            case 'boolean':
    ...
    */
    function triggerOnUnknown($element,$elementname,$method,$allowed_array)
    {
    ...
    */
    function bind ($id, $event, $bindto, $params = array())
    {
    ...
    */
    function bindInline ($bindto, $params = array(), $id = "")
    {
    ...
    */
    function bindPeriodicalTimer ($id, $event, $bindto, $timername, $timerms, $params = array())
    {
    ...
    */
    function bindPeriodicalTimerInline ($bindto, $timername, $timerms, $params = array(), $id = "")
    {
    ...
    */
    function bindTimer ($id, $event, $bindto, $timername, $timerms, $params = array())
    {
    ...
    * @return string JavaScript code to handle the binding.
    */
    function bindTimerInline ($bindto, $timername, $timerms, $params = array(), $id = "")
    {
    ...
    */
    function htmlSetValue ($element,$value)
    {
        if(!$this->triggerOnEmpty($element, "element", "htmlEnable"))
        {
    ...
    * @return string JavaScript code to handle the binding.
    */    
    function onLoadBind ($bindto, $params = array())
    {
    ...
    * @return string JavaScript code to handle the binding.
    */    
    function onLoadBindTimer ($bindto, $params = array(), $timerms = 300)
    {
    ...
    * @return string JavaScript code to handle the binding.
    */   
    function onLoadBindPeriodicalTimer ($bindto, $params = array(), $timerms = 300)
    {
    ...
    * @param boolean $value
    */
    function setEncodeValues($value)
    {
    ...
    */
    function setOutputHeaders ($value)
    {
